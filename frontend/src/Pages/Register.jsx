    ...
    return (
        <div className="flex items-center justify-center text-white h-screen container mx-auto py-[400px] px-20 ">
            <div
                ...
                data-aos="fade-left" className="flex flex-col items-center justify-center py-24 bg-gradient-to-r from-[#4546ED] to-[#272887] h-[600px] rounded-l-3xl w-1/2">
                <h1 className='text-4xl font-krona'>Welcome Back!</h1>
                <h1>To keep connected with us please login with your personal info</h1>
                <Link to='/login' className='my-16 rounded-full flex justify-center  p-3 w-40  bg-white font-bold hover:w-52 text-[#272887] duration-300'>SIGN IN</Link>
            </div>
            <div
                data-aos="fade-right" className="h-[600px] w-1/2 flex py-24 flex-col items-center justify-center border-4 border-[#272887] rounded-r-3xl">
                <h1 className='text-4xl font-krona' >Create Account</h1>
