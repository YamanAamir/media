  ...
  return (
    <div>
          ...
          <div className="w-full flex justify-center">
            <div className="w-full mx-2 md:w-1/2 text-center">
              <h1 className="text-5xl mb-4" data-aos="fade-right">
                Contribute to LYME CAY MEDIA
              </h1>
              <p className="text-2xl mb-6" data-aos="fade-left">
      ...
      <div className="flex flex-col justify-center items-center text-white py-12">
        <h1 className="text-5xl mb-4 text-center" data-aos="fade-down">
          Over 340,000 creators contribute to Unsplash.
        </h1>
        <div className="w-full flex flex-wrap justify-center my-10 gap-8">
          <div
            className="w-72 h-fit bg-white text-black p-4 rounded-lg shadow-lg"
            data-aos="fade-down"
          >
            ...
            <p>
              “Without realizing it, by uploading to Unsplash, I was making real
              and meaningful connections all over the world. I was helping
              change the way people interacted with photography and provided
              resources to those that didn’t have access to any before.”
            </p>
          </div>

          <div
            className="w-72 h-fit md:mt-12 bg-white text-black p-4 rounded-lg shadow-lg"
            data-aos="fade-up"
          >
            <div className="flex justify-between items-center py-2 mb-10">
              <div>
