        ...
        <div className="flex flex-col text-white py-5 ">
            <div className="flex items-center justify-center">
                <div className="flex flex-col text-center items-center gap-3 w-2/3 justify-center">
                    <h1 className="text-4xl font-semibold">Learn and Grow with Our Expert-Led Courses</h1>
                    <h1 className="text-md">Unlock your creative potential with our expert-led courses for all skill levels. Whether you're a beginner or a professional, our courses cover a wide range of media creation topics to help you grow and excel</h1>
                </div>
            </div>
            <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-10 p-5">
                {
                    cources.map((cource) => (
                        <div>
                            <div className="rounded-3xl h-[250px]  flex justify-center px-3 items-center" style={
                                {
            ...
            <div className="flex items-center justify-center">
                <button className='flex gap-3 items-center justify-center mb-5 rounded-full border p-5 w-52  hover:bg-gradient-to-r hover:from-[#4546ED] hover:to-[#272887]  hover:w-64 duration-300'> Explore More <img src={rightArrow} alt="" /></button>
            </div>
        </div>
    )
}
