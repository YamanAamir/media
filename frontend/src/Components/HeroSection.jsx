    ...
    return (
        <div className="flex justify-center items-center">
            <div className='flex flex-col justify-start md:gap-20 gap-32 md:py-32 py-12 text-white items-center mt-[90px] z-20 rounded-3xl min-h-screen '
                ...
                </div><button className='p-3 hover:px-10 duration-200 flex font-semibold flex-row items-center gap-2 absolute top-[9px] right-12 font-light bg-gradient-to-r from-[#4546ED] to-[#272887] px-7 rounded-full'>Search <IoSearch className='animate-pulse ' /></button>
