        ...
        <div className="flex justify-center items-center">
            <div className='flex flex-col justify-start md:gap-20 gap-32 md:py-32 py-12 text-white items-center mt-[90px]  rounded-3xl min-h-screen '
                ...
                <div className="flex justify-center text-center items-center flex-col">
                    <h1 className='md:text-6xl text-4xl md:w-2/3 w-full py-3'>Discover Premium Stock Media
                        for Your Creative Projects</h1>
                    <p className='text-md font-light md:w-1/2 w-2/3 '>Explore our vast library of videos, images, audio, and templates. Find flexible, affordable, and high-quality media for your projects.</p>
                ...
                <div className='w-full px-10 relative'>
                    ...
                    <button className='p-3 hover:px-10 duration-200 flex font-semibold flex-row items-center gap-2 absolute top-[9px] right-12 font-light bg-gradient-to-r from-[#4546ED] to-[#272887] px-7 rounded-full'>Search <IoSearch className='' /></button>
                </div>
