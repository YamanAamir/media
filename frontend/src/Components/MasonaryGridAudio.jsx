...
import { FaOpencart, FaVolumeMute, FaVolumeUp } from 'react-icons/fa';
    ...
    <div className="relative min-h-screen">
        ...
        {images.map((imageItem, index) => (
          <div key={index} className="relative mb-4 break-inside group">
            ...
            <div className="absolute top-4 p-2 right-4 z-50 cursor-pointer bg-gradient-to-r from-[#5354F4] to-[#2C2DE2] rounded-full hover:border hover:bg-none" onClick={() => setIsMuted(!isMuted)}>
        {isMuted ? <FaVolumeUp className="text-lg text-white" /> : <FaVolumeMute className="text-lg text-white" /> }
      </div>
...
export default MasonryGridAudio;
